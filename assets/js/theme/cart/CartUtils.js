...
export default class CartUtils {
  ...
  _bindEvents() {
    ...
    const updateQty = _.bind(_.debounce(this._updateCartItem, 750), this);

    // Bind updates to the qty control widget.
    $('[data-cart-content]').on('change', '[data-quantity-control-input]', (event) => {
      updateQty(event);
    });
